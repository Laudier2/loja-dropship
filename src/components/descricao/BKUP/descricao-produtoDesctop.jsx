...
const Descricao = () => {
  ...
  console.log(productFilter[0].image)

  const [imgSet, setSet] = useState(productFilter[0].image[0])
            ...
            return (
              <>
                <div className="div2" id="logo">
                  ...
                  <div className="div3">
                    <div className='div1' >
                      <img src={image[0] || image[1]} alt="img0" onClick={() => setSet(image[0])} />
                    </div>
                     <div className='div1' >
                      <img src={image[1] || image[2]} alt="img0" onClick={() => setSet(image[1])} />
                    </div>
                     <div className='div1' >
                      <img src={image[2] || image[3]} alt="img0" onClick={() => setSet(image[2])} />
                    </div>
                     <div className='div1' >
                      <img src={image[3] || image[0]} alt="img0" onClick={() => setSet(image[3])} />
                    </div>
                     <div className='div1' >
                      <img src={image[4] || image[2]} alt="img0" onClick={() => setSet(image[4])} />
                    </div>
                  </div>
                </div>
                <ContainerDesc>
