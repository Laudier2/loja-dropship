            ...
            <div className="divdesc">
              ...
              <FaCreditCard className='mt-1 m-1'/> Em até 12x sem juros
                ...
                <div role="group" aria-label="Basic example">
                  ...
                  {FilterColor7[0] ? <button type="button" style={{background: "#22283B", border: "none", color: "red", padding: "15px"}} onClick={() => Cores(FilterColor7[0])}></button> : ""}
